```
Title: 10 Unity Client Architecture
Doc ID / filename: 10-unity-client-architecture.md
Status: Active
...
Short summary: The Unity client is the user-facing half of the platform. It is responsible for rendering the 3D city, animating avatars, managing real-time networ...
Contact: oparagregory
```

**TL;DR:** The Unity client is the user-facing half of the platform. It is responsible for rendering the 3D city, animating avatars, managing real-time networ...

## New: `10-unity-client-architecture.md`
